...
class BookSellerOtherImage extends Model
{
    ...
    public static function newOtherImage($id, $images)
    {
        foreach ($images as $image) {
            self::$otherImage = new BookSellerOtherImage();
            self::$otherImage->seller_id = Auth::guard('seller')->user()->id;
    ...
    {
        self::$otherImages = BookSellerOtherImage::where('book_id', $id)->get();
