...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index($request)
    {
        ...
        $post_data['value_a'] = Auth::guard('customer')->user()->email;
        $post_data['value_b'] = Auth::guard('customer')->user()->password;
    ...
    public function success(Request $request)
    {
        ...
        // dd( $customer);
        Auth::guard('customer')->attempt(['email' => $request->value_a, 'password' => $request->value_b]);
