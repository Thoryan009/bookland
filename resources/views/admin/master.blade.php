    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M237.721 1.18923L125 70.3075V136.87L250 65.2465V8.06814C250 3.61223 246.389 0 241.935 0C240.448 0 238.99 0.411583 237.721 1.18923Z" fill="white" fill-opacity="0.3" />
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                        <i class="menu-icon tf-icons ri-user-line"></i>
                        <div>Seller Module</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="{{route('all.seller')}}" class="menu-link">
                                <div>All Seller</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('seller.all.books')}}" class="menu-link">
                                <div>All Books</div>
                            </a>
                        </li>

                        <li class="menu-item">
                            <a href="{{route('seller.request.page')}}" class="menu-link">
                    ...
                    <div class="container-xxl">
                        <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
                            <div class="text-body mb-2 mb-md-0">
                                ...
                                </script>, made with <span class="text-danger"><i class="tf-icons ri-heart-fill"></i></span> by <a href="https://themeselection.com/" target="_blank" class="footer-link">City University</a>
                            </div>
                        </div>
                    </div>
                </footer>
