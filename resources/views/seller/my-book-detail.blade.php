                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-8 m-b30">
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td>Book Category</td>
                                    <td>{{ isset($book->category->name) ? $book->category->name : 'NA' }}</td>
                                </tr>
                                <tr>
                                    <td>Book Sub Category</td>
                                    <td>{{ isset($book->subCategory->name) ? $book->subCategory->name : 'NA' }}</td>
                                </tr>
                                <tr>
                                    <td>Book Brand</td>
                                    <td>{{ isset($book->publisher->name) ? $book->publisher->name : 'NA' }}</td>
                                </tr>
