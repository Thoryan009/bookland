        ...
        <section class="content-inner-1 border-bottom">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="title">Books > Old Books</h4>
                </div>
                ...
                <div class="row book-grid-row">
                    ...
                    <div class="col-book style-1">
                        <div class="dz-shop-card style-1">
                            <div class="dz-media">
                                <a href="{{route('old-book.detail', ['id' => $book->id])}}"><img  src="{{asset($book->image)}}" alt="book"></a>
                            </div>
                            ...
                            <div class="dz-content">
                                <h5 class="title"><a href="{{route('old-book.detail', ['id' => $book->id])}}">{{$book->name}}</a></h5>
                                <ul class="dz-tags">

                                    <li><a href="books-grid-view.html">{{$book->author_name}}</a></li>
